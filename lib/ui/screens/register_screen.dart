...
import 'package:tinder_app_flutter/ui/screens/register_sub_screens/preferred_match.dart';
import 'package:tinder_app_flutter/ui/screens/register_sub_screens/search_location.dart';
import 'package:tinder_app_flutter/ui/screens/register_sub_screens/select_gender.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget getSubScreen() {
    switch (_currentScreenIndex) {
      ...
      case 3:
        return SelectGender(
          onChanged: (value) =>
          {_userRegistration.userGender = value, print(value)});
      case 4:
        return PrefPotentialMatches(
          onChanged: (value) =>
              { _userRegistration.preferredMatchType = value}
        );
      case 5:
        return SearchLocationPage(
          onLocationChanged: (value ) { _userRegistration.location = value;  print("herehrehrhere"); print(_userRegistration.location);},
        );
      case 6:
  ...
  bool canContinueToNextSubScreen() {
    switch (_currentScreenIndex) {
      ...
      case 3:
        return _userRegistration.userGender == 'Male' || _userRegistration.userGender == 'Female' || _userRegistration.userGender == 'Other';
      case 4:
        return _userRegistration.preferredMatchType == 'Male' || _userRegistration.preferredMatchType == 'Female' || _userRegistration.preferredMatchType == 'Both';
      case 5:
        return _userRegistration.location != null;
      default:
        return false;
    }
  }
